...
$result = mysqli_query($con, "SELECT count('id') FROM students");
$rows = mysqli_fetch_array($result);

$studentsuccess = mysqli_query($con, "SELECT count('id') FROM studentsuccess");
$studentsuccessrows = mysqli_fetch_array($studentsuccess);
            ...
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        ...
                        <span>
                            <!-- dark Logo text -->
                            <img src="../assets/images/logo-text.png" alt="homepage" style="width:98%" class="dark-logo" />
                        </span>
                    </a>
                </div>
                <!-- ============================================================== -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="result.php" class="waves-effect"><i class="fa fa-table m-r-10" aria-hidden="true"></i>Result</a>
                        </li>
                    </ul>
                </nav>
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Total Applicant</h4>
                                <div class="text-right">
                                    <h2 class="font-light m-b-0"><i class="ti-arrow-up text-success"></i> <?php echo "$rows[0]"; ?></h2>
                                    <!-- <span class="text-muted">Todays Applicant</span> -->
                                </div>
